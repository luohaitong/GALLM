# to fill in the following path to run the second stage!
...
pretra_gnn=pretrained_gnn/${dataset_stage2}_gt/
tuned_proj=checkpoints/${dataset_stage1}/graph_projector.bin
output_model=checkpoints/${dataset_stage2}/${id}
